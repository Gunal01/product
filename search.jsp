		...
		<div class="collapse navbar-collapse" id="navbar">
			...
			<div class="menu-top-menu-container">
				<ul id="menu-top-menu" class="nav navbar-nav nav-list">
					...
					<li style="background: rgba(255, 255, 0, 0.51);"><a  href="register.jsp">Company Register</a></li>
				</ul>
			</div>
		</div>
		<!-- /.navbar-collapse -->
...
<section id="home" style="padding:160px 0;background-image: url(https://unsplash.it/1324/683?random=0); background-position: center; background-repeat: no-repeat;background-size: cover;background-attachment:fixed;">
	<div class="container">
		<div class="textwidget">
			<h1 class="toptitle">SEARCH <br/> THE PRODUCT <br/><br/><i class="fa fa-star roundicon"></i>
			</h1>								
			<div class="contactstyle topform">										
				<form method="post" action="search_details.jsp" id="topcontactform">
					<div class="form">						
						<input type="number" name="email" placeholder="Enter the Product ID">						
