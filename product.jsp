...
<section id="home" style="padding:160px 0;background-image: url(https://unsplash.it/1324/683?random=0); background-position: center; background-repeat: no-repeat;background-size: cover;background-attachment:fixed;">
    <div class="container" >
		<div class="textwidget">
			<h1 class="toptitle">MEMBER APPROVAL<br/><br/><i class="fa fa-star roundicon"></i>
			</h1>								
                    <br>								
...
FileReader reader=new FileReader(com.connect.access.user);
    ...
    <tbody>
      ...
      <tr>
        ...
        <%if(p.getProperty(value+"file").equals("false")){ %>
    <form action="upload" method="post" enctype="multipart/form-data"><td> <input type="file" id="myfile" name="myfile"></td>        
         <td><input type="submit" id="submit" class="clearfix btn" value="Upload"></td></form>
    <%}else{%>
    <td><%= p.getProperty(value+"file") %></td>
        <td><%if(p.getProperty(value+"app")==null){
            out.print("Uploaded");
        }else{
           out.print("Approved");  
    }  %></td>
